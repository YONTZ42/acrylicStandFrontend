...
export function AppFooter() {
  return (
    <footer className="relative z-50 flex flex-col items-center justify-center py-3 border-t border-white/10 bg-[#050506]/80 backdrop-blur-md px-4 pb-safe shadow-[0_-4px_20px_rgba(0,0,0,0.2)]">
      <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[10px] font-bold text-brand-text-soft/70 mb-1.5">
