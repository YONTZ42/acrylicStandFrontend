...
export function RoomBottomNav({ collectionCount, onOpenDrawer, onOpenShop }: Props) {
  ...
  return (
    <div className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 z-20 pointer-events-none w-full max-w-[28rem] px-4">
      {/* 高級感のあるガラスUI */}
      <div className="pointer-events-auto flex items-center justify-between bg-black/40 backdrop-blur-xl px-4 py-3 sm:px-6 sm:py-4 rounded-[2rem] border border-white/20 shadow-glass">
        ...
        >
          <Library size={22} strokeWidth={1.5} className="group-hover:-translate-y-1 transition-transform" />
        ...
        >
          <Wand2 size={24} strokeWidth={1.5} className="group-hover:-translate-y-1 transition-transform drop-shadow-md" />
          <span className="text-[11px] sm:text-xs font-bold tracking-wide drop-shadow-md">作る</span>
        </button>
        ...
        >
          <ShoppingBag size={22} strokeWidth={1.5} className="group-hover:-translate-y-1 transition-transform" />
          <span className="text-[11px] sm:text-xs font-medium tracking-wide">ショップ</span>
        </button>
        ...
        >
          ...
          <span className="text-[11px] sm:text-xs font-medium tracking-wide whitespace-nowrap">みんなの祭壇</span>
        </button>
